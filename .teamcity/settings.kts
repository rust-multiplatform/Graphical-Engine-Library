...
project {
    ...
    buildType(OpenSourceProjects_RustMultiplatform_ComputeEngineExampleComputing_Test)
    buildType(OpenSourceProjects_RustMultiplatform_ComputeEngineExampleComputing_Build)
}

object OpenSourceProjects_RustMultiplatform_ComputeEngineExampleComputing_Build : BuildType({
    id("Build")
    name = "Build"
...
object OpenSourceProjects_RustMultiplatform_ComputeEngineExampleComputing_Test : BuildType({
    id("Test")
    name = "Test"
