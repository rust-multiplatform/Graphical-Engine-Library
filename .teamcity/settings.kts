...
project {
    ...
    buildType(OpenSourceProjects_RustMultiplatform_ComputeEngineExampleBufferCopying_Build)
    buildType(OpenSourceProjects_RustMultiplatform_ComputeEngineExampleBufferCopying_Test)
}

object OpenSourceProjects_RustMultiplatform_ComputeEngineExampleBufferCopying_Build : BuildType({
    id("Build")
    name = "Build"
...
object OpenSourceProjects_RustMultiplatform_ComputeEngineExampleBufferCopying_Test : BuildType({
    id("Test")
    name = "Test"
